...
const translations = {
    'en': {
        ...
        'tool_cropper_kicker': 'Multi-Action Pipeline & Batch Processing',
        'tool_cropper_desc': 'Pure local browser-based batch image processing workstation. Features smart resizing, aspect ratio cropping, text & PNG logo watermarking, USM sharpening & color adjustments, batch renaming, format conversion, and live Before/After comparison.',
        ...
        'tool_pano_badge': '360° WebGL Inspector',
        'tool_pano_title': '360 Panorama Inspector',
        'tool_pano_kicker': 'WebGL Equirectangular & A/B Wipe',
        'tool_pano_desc': 'Pure browser-based 360 panorama viewer for automotive CGI interiors and architecture. Drag and drop local 2:1 equirectangular renders directly into viewports. Features hardware-accelerated curtain wipe, synchronized dual-stage, camera angle presets, and 360 snapshot export.',
    ...
    'zh': {
        ...
        'tool_cropper_title': '批量图片处理工作站',
        'tool_cropper_kicker': '多动作流水线 · 纯本地极速计算',
        'tool_cropper_desc': '纯浏览器本地运行的批量图片处理工作站。包含最长边智能缩放、多画幅比例裁切、文字与透明 Logo 水印、USM 锐化与画质增强、批量重命名规则、多格式压缩转换及实时前后对比视窗。',
        ...
        'tool_pano_badge': '360° WebGL 视窗',
        'tool_pano_title': '360° 全景图对比预览器',
        'tool_pano_kicker': '等距柱状全景 · 硬件级帘幕对比与本地解析',
        'tool_pano_desc': '纯浏览器本地运行的 360° 全景图对比预览器。专为汽车内饰 CGI 与空间建筑渲染打造，可直接拖拽本地 2:1 等距柱状全景图进行实时预览。支持硬件级帘幕对比、左右双视口联动同步、预设机位切换与全景快照导出。',
